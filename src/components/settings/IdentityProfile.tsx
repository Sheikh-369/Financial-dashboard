      ...
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-3 md:col-span-2">
            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 ml-1">Professional Bio</label>
            <textarea 
              className="w-full bg-slate-50 dark:bg-[#0B1C30] border-none rounded-2xl px-5 py-4 text-[13px] font-bold text-slate-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white/20 transition-all outline-none leading-relaxed" 
              rows={3}
