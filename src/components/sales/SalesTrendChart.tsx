...
export default function SalesTrendChart() {
  return (
    <div className="bg-white dark:bg-[#132335] p-4 md:p-8 rounded-[2.5rem] border border-slate-100 dark:border-white/5 shadow-sm flex flex-col h-[480px] transition-all duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start mb-6 md:mb-10 gap-4">
        <div>
          <h4 className="text-lg md:text-xl font-black tracking-tight text-slate-900 dark:text-white">Monthly Sales Volume</h4>
      ...
      {/* Graph Area */}
      <div className="flex-1 flex items-end justify-between gap-2 md:gap-6 px-1 md:px-2 pb-2">
        {data.map((item) => (
