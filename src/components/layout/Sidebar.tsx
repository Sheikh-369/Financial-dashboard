...
//   return (
//     <>
//     {/* 1. THE DIMMER: Synchronized to xl:hidden to match RootLayout */}
//     {isOpen && (
//       <div 
...
//       /* DESKTOP LOGIC: Changed lg to xl to prevent iPad Pro overlap */
//       xl:translate-x-0
//     `}>
//       <div className="mb-10">
//         <h2 className="font-headline font-black text-2xl tracking-tighter text-[#0F172A] dark:text-white">
...
//               key={item.name}
//               href={item.href}
//               // 2. AUTO-HIDE: Closes sidebar on mobile when a link is clicked
//               onClick={() => {
