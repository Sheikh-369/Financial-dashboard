  ...
  return (
    <aside className="hidden md:flex flex-col h-screen w-64 fixed left-0 top-0 z-50 bg-[#F1F5F9] dark:bg-[#0B1C30] p-6 border-r border-slate-200 dark:border-white/5 transition-colors duration-500">
      ...
      <div className="mt-auto pt-6 space-y-4">
        ...
        <button className="w-full bg-[#0F172A] dark:bg-white text-white dark:text-[#0B1C30] py-3.5 rounded-xl font-black text-sm tracking-tight flex items-center justify-center gap-2 hover:opacity-90 transition-all shadow-lg active:scale-95">
          <span className="material-symbols-outlined text-lg">add</span>
          New Entry
        </button>
