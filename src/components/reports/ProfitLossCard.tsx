...
export default function ProfitLossCard() {
  return (
    <div className="bg-white dark:bg-[#132335] rounded-[2.5rem] p-10 border border-slate-100 dark:border-white/5 shadow-sm hover:shadow-2xl dark:hover:shadow-none transition-all duration-500 group cursor-pointer h-full flex flex-col justify-between overflow-hidden relative">
      ...
      <div className="flex justify-between items-start relative z-10">
        <div className="flex-1">
          ...
          <h3 className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white transition-colors leading-tight">
        ...
        {/* Large Ghost Icon */}
        <span className="material-symbols-outlined text-7xl text-slate-50 dark:text-white/5 group-hover:text-black dark:group-hover:text-white transition-all duration-700 select-none">
          description
        </span>
      </div>
      ...
      <div className="mt-16 grid grid-cols-3 gap-10 relative z-10">
        <div>
          ...
          <p className="text-4xl font-black text-slate-900 dark:text-white transition-colors">$248.5k</p>
        </div>
        <div>
